...
export function formatHelp(): string {
  const lines: string[] = [
    ...
    "/help \\- This message",
    "",
    "*Wallet Setup \\(Multi\\-User\\)*",
    "/link \\<address\\> \\- Link your wallet",
    "/verify \\<signature\\> \\- Verify wallet ownership",
    "/deploy \\- DelegatedAccount deployment guide",
    "/setaccount \\<address\\> \\- Set DelegatedAccount",
    "/whoami \\- Show your linked wallet",
...
export function formatWelcome(): string {
  const lines: string[] = [
    ...
    "",
    "*Getting Started:*",
    "1\\. /link \\<wallet\\> \\- Link your wallet",
    "2\\. /deploy \\- Deploy DelegatedAccount",
    "3\\. /setaccount \\<address\\> \\- Configure account",
    "4\\. Trade naturally\\!",
    "",
    "*Examples:*",
